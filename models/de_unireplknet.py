...
# @register_model
def de_unireplknet_a(in_1k_pretrained=False, **kwargs):
...
# @register_model
def de_unireplknet_f(in_1k_pretrained=False, **kwargs):
...
# @register_model
def de_unireplknet_p(in_1k_pretrained=False, **kwargs):
...
# @register_model
def de_unireplknet_n(in_1k_pretrained=False, **kwargs):
...
# @register_model
def de_unireplknet_t(in_1k_pretrained=False, **kwargs):
...
# @register_model
def de_unireplknet_s(in_1k_pretrained=False, in_22k_pretrained=False, in_22k_to_1k=False, **kwargs):
...
# @register_model
def de_unireplknet_b(in_22k_pretrained=False, in_22k_to_1k=False, **kwargs):
...
# @register_model
def de_unireplknet_l(in_22k_pretrained=False, in_22k_to_1k=False, **kwargs):
...
# @register_model
def de_unireplknet_xl(in_22k_pretrained=False, in_22k_to_1k=False, **kwargs):
